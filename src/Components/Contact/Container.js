...
export default function Container(){
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<h4 class="headline margin-bottom-30">Encontranos en</h4>
			...
			<div class="sidebar-textbox">
				...
				<ul class="contact-details">
					<li><i class="im im-icon-Phone-2"></i> <strong>Telefono:</strong> <span><a href="tel:55204000">42579699 </a></span></li>
					<li><i class="im im-icon-Envelope"></i> <strong>Correo:</strong> <span><a href="mailto:toyworld@gmail.com">toyworld@gmail.com</a></span></li>
				</ul>
			</div>
